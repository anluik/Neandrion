    ...
    return (
        <main className="relative min-h-full overflow-hidden">
            ...
            <div className="relative z-2 mx-auto w-[min(920px,calc(100%-2rem))] px-4 py-16">
                <section className="animate-rise rounded-2xl border border-(--line) bg-(--surface) p-6 transition-colors duration-500 motion-reduce:animate-none sm:p-8">
                    ...
                    <p className="m-0 max-w-3xl text-base/8 text-(--text-dim)">
